...
public class FlightsPage {
    ...
    //public static final Target BTN_DESTINATION =Target.the("").located(By.xpath("//div[contains(@id,'destination-airport-display-inner')]"));
    public static final Target BTN_DESTINATION =Target.the("").locatedBy("(div[id*='destination-airport-display-inner']");
